...
def plot_acc_prob_curve_20000(prob):
    x_train, y_train, y_train_small = misslabeled_data_genelization(loops=20000, prob=prob)
...
info20000 = list(map(plot_acc_prob_curve_20000,np.arange(0,1,.01)))

with open('noise_size_20000.pickle', 'wb') as f:
    pickle.dump(info20000, f)

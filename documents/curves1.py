...
def plot_acc_prob_curve_1000(prob):
...
info1000 = list(map(plot_acc_prob_curve_1000,np.arange(0,1,.01)))

with open('noise_size_1000.pickle', 'wb') as f:
    pickle.dump(info1000, f)
